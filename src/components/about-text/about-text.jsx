            ...
            <div className="about-container">
                <section className="grid info">
                    ...
                    <div className="column-xs-12 column-md-4">
                        <img src="https://images.unsplash.com/photo-1613125700782-8394bec3e89d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="WASD"/>
                    </div>
                    <div className="column-xs-12 column-md-7">
                        <div className="about-intro">
                            <h2 className="about-title">Find Your Own Journey</h2>
